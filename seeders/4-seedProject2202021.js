    ...
    up: async (queryInterface, Sequelize) => {
        await queryInterface.bulkInsert('Projects', [
            ...
            },
            {
                ...
                company: 'AECOM',
                role: 'Associate Arch. - Brackett-Krennerich Assoc.',
            ...
            },
            {
                ...
                company: 'Keyes Condon Florance Architects',
            ...
            },
            {
                ...
                overview: 'Working as part of the HOK Sport team, RTKL provided urban design studies and the overall sports complex master plan, including future football stadium, parking, light rail, and other components. Responsible for helping integrate the new Orioles baseball stadium into the Baltimore urban fabric. Major contributions included the recommendations for the angular forms of the exterior of the stadium façade, retention of the entire warehouse building, retention of Eutaw Street as a pedestrian spine through the stadium, and maintenance of contextual “street edges” around the historic Camden Station building.',
            ...
            },
            {
                ...
                overview: '1.0 million SF renovation and addition to historic Lambeau Field. The playing field and lower stadium bowl were retained and kept operational through 2 seasons of construction, while the surrounding ring of existing suites were replaced and enlarged. Project components included 174 new/replacement suites, 3,000 new indoor club seats, 3,200 new outdoor club seats, resulting in an overall stadium seating increase of 11,000 seats to a total capacity of 71,500 seats. Architecturally, the project preserves the historic character of Lambeau Field, using brick and steel components to express the solid work ethic of Green Bay. The 5-level indoor Titletown atrium is accessible to all fans during games, and is the focus of a 360- day/year tourist attraction. The project also provided 200,000 SF of new team office spaces and new team facilities. Concourse spaces and concession/toilet facilities were also significantly upgraded as part of the renovation.',
                timeframe: 'Phase 1 – September 2002. Phase II – September 2003. Worked closely with Turner Construction to achieve project completion in 2 off-seasons.',
            ...
            {
                name: 'Cornerstone Art & Craft Collaborative Website',
