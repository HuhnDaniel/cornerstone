                            ...
                            <article className={`bg-${discipline.image} bg-cover rounded-md text-white cursor-pointer mx-auto my-4 h-72 w-72 hover:shadow-md transition transition-transform duration-200 transform hover:scale-105`} key={i}>
                                ...
                                </div>
                                {
                                    discipline.artistCredit ? (
                                        <span className="absolute bottom-0 right-0 m-2 text-sm">Photo by <a href={discipline.artistCredit} target="_blank" rel="noopener noreferrer">{discipline.artistName}</a> on <a href={discipline.artistCredit} target="_blank" rel="noopener noreferrer">Unsplash</a></span>
                                    ) : (
                                        null
                                    )
                                }
